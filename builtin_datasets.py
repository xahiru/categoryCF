...
BuiltinDataset = namedtuple('BuiltinDataset', ['url', 'path', 'item_path', 'reader_params'])
...
BUILTIN_DATASETS = {
    'ml-100k':
        BuiltinDataset(
            ...
            item_path=join(get_dataset_dir(), 'ml-100k/ml-100k/u.item'),
    ...
    'ml-1m':
        BuiltinDataset(
            ...
            item_path=join(get_dataset_dir(), 'ml-100k/ml-100k/u.data'),
            reader_params=dict(line_format='user item rating timestamp',
                               rating_scale=(1, 5),
                               sep='::')
        ),
